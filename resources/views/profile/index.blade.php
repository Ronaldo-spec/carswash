        ...
        <div class="col-md-12 mt-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('/home-user/profile') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-2 col-form-label text-md-right">{{ __('Userame')
                                }}</label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-2 col-form-label text-md-right">{{ __('E-Mail Address')
                                }}</label>
